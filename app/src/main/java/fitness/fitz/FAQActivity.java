...
import fitness.fitz.data.QaAdapter;
import fitness.fitz.data.models.QA;
...
public class FAQActivity extends BaseActivity {
    ...
    public void mail() {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:" + "Ljeremiah0@gmail.com"));
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Issue - ");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Hello Fitness!");
